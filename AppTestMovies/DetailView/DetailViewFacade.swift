...
extension DetailViewController {
    ...
    func setBtnPlayConstraints() {
        NSLayoutConstraint.activate([
            btnPlay.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            btnPlay.topAnchor.constraint(equalTo: lblDescription.bottomAnchor, constant: 20),
            btnPlay.centerXAnchor.constraint(equalTo: contentView.centerXAnchor),
            btnPlay.heightAnchor.constraint(equalToConstant: 43),
            contentView.bottomAnchor.constraint(greaterThanOrEqualTo: btnPlay.bottomAnchor, constant: 30),
        ])
    }
